...
// ANSWER:
let numbers2 = [...numbers];
  console.log(numbers[i] * numbers2[i]);

// 15) Here are two functions that you came up with to count how many of each 
//letter is in a given string and return an object with the individual counts: 
...
// ANSWER - countLetters:3n = 3*26 = 78
// ANSWER - countLettersRoundTwo:n = 26


// Q: Explain how you came to your conclusions about the space complexity of each function. 
// ANSWER: countLetters is operated in 3 steps
//countLettersRoundTwo is operated in one countLettersRoundTwo.
